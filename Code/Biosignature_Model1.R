...
X2024_BisognatureSamples_PhotosynthesisStudy_17AUG <- read_excel("~/Documents/PaleobioSignature_Project/2025-PhotosynthesisStudy-01APR-9categories-Updated.xlsx")
...
rf2$votes
write.csv(rf2$votes,"~/Downloads/Biosign_Model1_Training_Probability.csv")
hist(rf2$votes[,1])
...
write.csv(wrong_final_pred,"~/Downloads/Biosign_Model1_WronglyPred_May21.csv")
...
# For Truly Unknown samples, just run the predict function on all 406 samples and then filter the unknowns of your interest. 
