...
library(readxl)
X2024_BisognatureSamples_PhotosynthesisStudy_17AUG <- read_excel("~/Documents/PaleobioSignature_Project/2025-PhotosynthesisStudy-02APR-OnlyRMH.xlsx")
...
rf2$votes
write.csv(rf2$votes,"~/Downloads/Biosign_Model3_Training_Probability.csv")
hist(rf2$votes[,1])
...
write.csv(wrong_final_pred,"~/Downloads/Biosign_Model3_WronglyPred_May21.csv")
...
Biosign_Supervised_Unknown <- Biosign_Supervised[,c(1,3,7,21:8723)]
...
write.csv(merged_unknown_results,"~/Downloads/Biosign_Model3_Biotic_v_Abiotic_All406_UnknownPred_April7.csv")
...
# For Biotic
write.csv(merged_unknown_results,"~/Downloads/Biosign_Model3_UnknownPred_May21.csv")
